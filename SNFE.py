...
LastEditTime: 2022-09-14 19:04:33
...
if Debug_enable =='1':
    print("Debug enable")
    logging.basicConfig(filename=args.logpath, filemode="w", format="%(levelname)s:%(message)s", datefmt="%d-%M-%Y %H:%M:%S", level=logging.DEBUG)
...
if Debug_enable =='1':
    logging.info('Input circuit netlist name: ' + args.Netlist_file  )
